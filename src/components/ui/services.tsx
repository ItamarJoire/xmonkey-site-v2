    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-2 md:gap-0 xl:mt-24">
            <div className="md:p-8 lg:p-14 ">
                ...
                <h3 className="mt-12 text-xl sm:text-2xl font-bold text-white font-pj">Support</h3>
                <p className="mt-5 text-base text-gray-400 sm:text-lg">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-l md:border-gray-400/25">
                ...
                <h3 className="mt-12 text-xl sm:text-2xl font-bold text-white font-pj">Sales</h3>
                <p className="mt-5 text-base text-gray-400 sm:text-lg">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-t md:border-gray-400/25">
                ...
                <h3 className="mt-12 text-xl sm:text-2xl font-bold text-white font-pj">Onboarding</h3>
                <p className="mt-5 text-base text-gray-400 sm:text-lg">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
            </div>
            ...
            <div className="md:p-8 lg:p-14 md:border-t md:border-l md:border-gray-400/25">
                ...
                <h3 className="mt-12 text-xl sm:text-2xl font-bold text-white font-pj">Product</h3>
                <p className="mt-5 text-base text-gray-400 sm:text-lg">Lorem ipsum dolor sit amet, consectetur adipis elit. Sit enim nec, proin faucibus nibh et sagittis a. Lacinia purus ac amet.</p>
            </div>

  ...
  return(
    <nav className="fixed z-50 inset-0 mt-4 border-[1px] border-white/5 bg-[#171719] h-16 w-[80%] mx-auto rounded-[40px]">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between md:justify-evenly lg:justify-between mx-auto ">
        ...
        <div className={`${open ? 'top-[54px]' : 'top-[-148px]'} absolute transition-all z-50 md:z-10 md:pr-4 duration-400 ease-in w-[100%] md:static  md:block md:w-auto text-center`} id="navbar-solid-bg">
          <ul className="flex flex-col font-medium mt-4  md:space-x-8 rounded-b-[40px] rtl:space-x-reverse md:flex-row md:mt-3 md:border-0 md:bg-transparent">
            ...
            <li onClick={() => setOpen(!open)} className="bg-[#171719] px-3 py-2 rounded-lg">
              <a href="#" className="text-sm lg:text-base font-semibold block pt-4 pb-6 lg:pt-0 lg:pb-0 px-4 md:p-0 text-white rounded md:hover:bg-transparent md:border-0 md:hover:text-primary-300 md:duration-150">Portfólio</a>
            </li>
          </ul>
        </div>
      </div>

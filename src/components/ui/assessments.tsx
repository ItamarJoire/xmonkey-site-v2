...
export function Assessments() {
  return (
    <section>
      <h2 className="title-section-2 text-xl text-center">
        Não somos nós que estamos dizendo. <br />
        Dá uma conferida nas nossas avaliações:
      </h2>
...
const testimonials = [
  ...
  {
    quote:
      'Equipe dinâmica, atenciosa e super competente... ser cliente da SparkVibe está sendo uma experiência bacana, conseguem unir um excelente atendimento, muito profissionalismo e um alto astral lá nas nuvens...',
    name: 'Vitor Gois',
    title: 'há 11 meses',
    img: Img3
  },
  ...
  {
    quote: 'Experiência incrível, recomendo demais! Pessoas muito competentes, obrigada pelo serviço 🤝🏽',
    name: 'Bruna Varela',
    title: 'há 10 meses',
    img: Img7
  }
